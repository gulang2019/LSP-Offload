...
def train():
    ...
    # Filter out the samples exceeding the maximum length
    # train_dataset = train_dataset.filter(
    #     lambda x: len(x["input_ids"]) <= training_args.model_max_length, batched=False
    # )

    # filtered_dataset_len = len(train_dataset)
    # print(
    #     "Filtered out {} samples exceeding the maximum length.".format(
    #         original_dataset_len - filtered_dataset_len
    #     )
    # )
    # print(
    #     "Filtered rate: {:.2f}%".format(
    #         (original_dataset_len - filtered_dataset_len) / original_dataset_len * 100
    #     )
    # )
    ...
    training_args.optim_target_modules = [
        "q_proj",
        "k_proj",
        "v_proj",
        "o_proj",
