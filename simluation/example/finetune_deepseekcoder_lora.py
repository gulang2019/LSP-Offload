...
def train():
    ...
    # print("Filtered out {} samples exceeding the maximum length.".format(original_dataset_len - filtered_dataset_len))
    # print("Filtered rate: {:.2f}%".format((original_dataset_len - filtered_dataset_len) / original_dataset_len * 100))
